...
from pandapower.pypower import idx_bus_sc

C_MIN = idx_bus_sc.C_MIN
C_MAX = idx_bus_sc.C_MAX
KAPPA = idx_bus_sc.KAPPA
R_EQUIV = idx_bus_sc.R_EQUIV
IP = idx_bus_sc.IP
ITH = idx_bus_sc.ITH
X_EQUIV = idx_bus_sc.X_EQUIV
IKCV = idx_bus_sc.IKCV
M = idx_bus_sc.M
R_EQUIV_OHM = idx_bus_sc.R_EQUIV_OHM
X_EQUIV_OHM = idx_bus_sc.X_EQUIV_OHM
V_G = idx_bus_sc.V_G
K_SG = idx_bus_sc.K_SG
SKSS = idx_bus_sc.SKSS
IKSSV = idx_bus_sc.IKSSV if hasattr(idx_bus_sc, "IKSSV") else idx_bus_sc.IKSS1
IKSSC = idx_bus_sc.IKSSC if hasattr(idx_bus_sc, "IKSSC") else idx_bus_sc.IKSS2
PHI_IKSSV_DEGREE = idx_bus_sc.PHI_IKSSV_DEGREE if hasattr(idx_bus_sc, "PHI_IKSSV_DEGREE") else idx_bus_sc.PHI_IKSS1_DEGREE
PHI_IKSSC_DEGREE = idx_bus_sc.PHI_IKSSC_DEGREE if hasattr(idx_bus_sc, "PHI_IKSSC_DEGREE") else idx_bus_sc.PHI_IKSS2_DEGREE
PHI_IKCV_DEGREE = idx_bus_sc.PHI_IKCV_DEGREE
from multiconductor.shortcircuit.impedance import _calc_zbus_diag
